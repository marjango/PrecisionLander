        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            ...
            >
              ...
              <SwiperSlide><WistiaEmbed2 /></SwiperSlide>
              <SwiperSlide><WistiaEmbed3 /></SwiperSlide>
            </Swiper>

            <div ref={prevRef} className="custom-prev absolute top-1/2 left-4 z-10 flex items-center justify-center w-10 h-10 bg-white text-gray-800 rounded-full shadow-md transform -translate-y-1/2 hover:bg-gray-100 transition duration-300">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                </svg>
            </div>

            <div ref={nextRef} className="custom-next absolute top-1/2 right-4 z-10 flex items-center justify-center w-10 h-10 bg-white text-gray-800 rounded-full shadow-md transform -translate-y-1/2 hover:bg-gray-100 transition duration-300">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
