...
<script src="https://fast.wistia.com/player.js" async></script><script src="https://fast.wistia.com/embed/wixeiqmc14.js" async type="module"></script><style>wistia-player[media-id='wixeiqmc14']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/wixeiqmc14/swatch'); display: block; filter: blur(5px); padding-top:177.78%; }</style> <wistia-player media-id="wixeiqmc14" aspect="0.5625"></wistia-player>
