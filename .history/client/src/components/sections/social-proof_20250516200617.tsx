      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative">
            ...
            >
              <SwiperSlide className="h-[200px] transform scale-75 transition-transform duration-300"><WistiaEmbed1 /></SwiperSlide>
              <SwiperSlide className="w-[200px] transform scale-75 transition-transform duration-300"><WistiaEmbed2 /></SwiperSlide>
              <SwiperSlide className="w-[200px] transform scale-75 transition-transform duration-300"><WistiaEmbed3 /></SwiperSlide>
            </Swiper>
