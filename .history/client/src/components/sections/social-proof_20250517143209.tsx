          ...
          <div className="relative ">
            ...
            >
              ...
              <SwiperSlide onClick={() => handleSlideClick(2)}><WistiaEmbed3 /></SwiperSlide>
               <SwiperSlide onClick={() => handleSlideClick(3)}><WistiaEmbed1 /></SwiperSlide>
                <SwiperSlide onClick={() => handleSlideClick(4)}><WistiaEmbed2 /></SwiperSlide>
              <SwiperSlide onClick={() => handleSlideClick(5)}><WistiaEmbed3 /></SwiperSlide>
            </Swiper>
