...
export function WistiaEmbed1() {
  useEffect(() => {
    ...
    script2.src = "https://fast.wistia.com/embed/wixeiqmc14.js";
    script2.async = true;
    script2.type = "module";
    ...
    style.textContent = `
      wistia-player[media-id='wixeiqmc14']:not(:defined) {
        background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/wixeiqmc14/swatch');
        display: block;
        filter: blur(5px);
        height: 100%;
        width: 100%;
