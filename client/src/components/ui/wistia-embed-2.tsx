...
export function WistiaEmbed2() {
  useEffect(() => {
    ...
    script2.src = "https://fast.wistia.com/embed/0edchi4wlw.js";
    script2.async = true;
    script2.type = "module";
    ...
    style.textContent = `
      wistia-player[media-id='0edchi4wlw']:not(:defined) {
        background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/0edchi4wlw/swatch');
        display: block;
        filter: blur(5px);
        height: 100%;
        width: 100%;
