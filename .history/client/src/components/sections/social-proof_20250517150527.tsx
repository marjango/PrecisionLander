      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className=" max-w-4xl mx-auto">
          <div className="relative ">
            ...
            >
              <SwiperSlide onClick={() => handleSlideClick(0)} style={{ maxHeight: '50%' }}><WistiaEmbed1 /></SwiperSlide>
              <SwiperSlide onClick={() => handleSlideClick(1)}  style={{ maxHeight: '50%' }}><WistiaEmbed2 /></SwiperSlide>
              <SwiperSlide onClick={() => handleSlideClick(2)}  style={{ maxHeight: '50%' }}><WistiaEmbed3 /></SwiperSlide>
            </Swiper>
